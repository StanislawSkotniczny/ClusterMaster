<template>
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div v-if="isLoading" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="text-center">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ statusMessage }}</p>
          ...
          <!-- Progress Percentage -->
          <div class="text-xs text-gray-500 dark:text-gray-400">{{ Math.round(progress) }}%</div>
    ...
    <!-- Header -->
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-6 transition-all">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Nowy Klaster</h1>
      <p class="text-gray-600 dark:text-gray-400">Skonfiguruj i utwórz nowy klaster Kubernetes</p>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="space-y-6">
          <div class="border-b border-gray-100 dark:border-gray-700 pb-6">
              <label for="provider" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Tryb klastra</label>
              <select
                id="provider"
            ...
            <div>
              <label for="clusterName" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Nazwa klastra</label>
              <input
                id="clusterName"
            ...
            <div>
              <label for="nodeCount" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Liczba węzłów</label>
              <div class="flex items-center">
                <input
                  ...
                  type="number"
                  min="1"
                  class="form-input w-36 rounded-md bg-gray-50 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800"
                  required
                />
                <div class="ml-3">
            ...
            <div v-else class="pt-4">
              <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mb-4 border-t border-gray-100 dark:border-gray-700 pt-4">Konfiguracja lokalna</h3>
              
              <!-- K3D vs Kind Selection -->
              <div class="mb-6">
                <label class="block text-gray-700 dark:text-gray-300 font-medium mb-3">Provider lokalnego klastra</label>
                <div class="grid grid-cols-2 gap-4">
                  <button
                    type="button"
                    ...
                    <div class="flex items-start">
                      <div class="flex-shrink-0 mr-3">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center"
                          :class="form.localClusterType === 'kind' ? 'bg-blue-500' : 'bg-gray-300 dark:bg-gray-600'">
                          <span class="text-white text-lg">🔵</span>
                        </div>
                      </div>
                      <div class="flex-1">
                        <div class="font-semibold text-gray-900 dark:text-gray-100 mb-1">Kind</div>
                  ...
                  >
                    <div class="flex items-start">
                      <div class="flex-shrink-0 mr-3">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center"
                          :class="form.localClusterType === 'k3d' ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'">
                          <span class="text-white text-lg">🚀</span>
                        </div>
                      </div>
                      <div class="flex-1">
                        <div class="font-semibold text-gray-900 dark:text-gray-100 mb-1">
                          k3d
                          <span class="ml-1 text-xs bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 px-1.5 py-0.5 rounded">ZALECANY</span>
                        </div>
                        <div class="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <div v-if="form.localClusterType === 'k3d'" 
                  class="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
                  <div class="flex items-start">
                    ...
                    <div class="text-xs text-green-800 dark:text-green-300">
                      ...
                      <span class="text-xs text-gray-600 dark:text-gray-400 mt-1 block">
                        ⚠️ Wymaga instalacji k3d: <code class="bg-gray-100 dark:bg-gray-800 px-1">choco install k3d</code> 
                        lub pobierz z <a href="https://k3d.io" target="_blank" class="text-blue-600 dark:text-blue-400 underline">k3d.io</a>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <label for="kubeconfigPath" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Ścieżka kubeconfig</label>
              <input
                id="kubeconfigPath"
          ...
          <div class="space-y-6">
            <div>
              ...
              <label for="clusterProfile" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Profil klastra</label>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
              <div class="flex items-center justify-between mb-3">
                <label class="block text-gray-700 dark:text-gray-300 font-medium">Niestandardowe zasoby (opcjonalnie)</label>
                <span class="text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md">Własne ustawienia</span>
              </div>
              
              <div class="grid grid-cols-3 gap-4">
                <div>
                  <label for="cpu" class="block text-gray-600 dark:text-gray-400 text-sm mb-1">CPU (rdzenie)</label>
                  <input
                    id="cpu"
                    v-model.number="form.cpu"
                    type="number"
                    min="1"
                    class="form-input w-full rounded-md bg-white dark:bg-gray-600 border-gray-300 dark:border-gray-500 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800"
                    placeholder="np. 2"
                  />
                </div>
                <div>
                  <label for="memory" class="block text-gray-600 dark:text-gray-400 text-sm mb-1">Pamięć (GB)</label>
                  <input
                    id="memory"
                ...
                <div>
                  <label for="disk" class="block text-gray-600 dark:text-gray-400 text-sm mb-1">Dysk (GB)</label>
                  <input
                    id="disk"
            ...
            <details class="bg-gray-50 dark:bg-gray-700 p-5 rounded-xl border border-gray-200 dark:border-gray-600 group">
              ...
              <div class="mt-4 space-y-5 pt-4 border-t border-gray-200 dark:border-gray-600">
                <div>
                  <label for="k8sVersion" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Wersja Kubernetes</label>
                  <select 
                    id="k8sVersion" 
                ...
                <div class="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                  <label class="flex items-center mb-3">
                    ...
                    />
                    <span class="ml-2 font-medium text-gray-700 dark:text-gray-300">Włącz autoskalowanie</span>
                  </label>
                  
                  <div v-if="form.enableAutoscaling" class="mt-3 grid grid-cols-2 gap-4">
                    <div>
                      <label for="minNodes" class="block text-gray-700 dark:text-gray-300 text-sm mb-1">Min. węzłów</label>
                      <input
                        id="minNodes"
                    ...
                    <div>
                      <label for="maxNodes" class="block text-gray-700 dark:text-gray-300 text-sm mb-1">Max. węzłów</label>
                      <input
                        id="maxNodes"
                ...
                <div>
                  <label for="tags" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Tagi</label>
                  <input
                    id="tags"
                    v-model="form.tags"
                    type="text"
                    placeholder="np. env=dev,team=devops"
                    class="form-input w-full rounded-md bg-white dark:bg-gray-600 border-gray-300 dark:border-gray-500 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-200 dark:focus:ring-blue-800"
                  />
        ...
        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
          ...
          <button
            ...
            class="px-6 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 transition-colors"
          >
...
async function handleSubmit() {
  ...
  try {
    ...
    clearInterval(progressInterval)
    progress.value = 0
    statusMessage.value = `Błąd: ${error instanceof Error ? error.message : 'Nieznany błąd'}`
