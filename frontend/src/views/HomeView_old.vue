      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex justify-between items-center">
          ...
          <nav class="hidden md:flex space-x-2">
            <router-link 
              to="/" 
              class="flex items-center space-x-2 text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium transition-colors"
              :class="{ 'bg-blue-500 text-white hover:bg-blue-600': $route.path === '/' }"
            >
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            <router-link 
              to="/deploy" 
              class="flex items-center space-x-2 text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium transition-colors"
              :class="{ 'bg-blue-500 text-white hover:bg-blue-600': $route.path === '/deploy' }"
            >
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
